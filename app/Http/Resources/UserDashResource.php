...
class UserDashResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'owner_upgrade_requests' => [
                'request_id' => $this->ownerRequest?->id,
                'request_status' => $this->ownerRequest?->request_status,
                'request_rejected_reason' => $this->ownerRequest?->request_rejected_reason,
            ],
        ];
    }
}
